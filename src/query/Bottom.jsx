  ...
  return (
    <div className="bottom">
      <div className="bottom-filters">
        <span
          className="item"
          onClick={() => !isFilterVisible && toggleOrderType()}
        >
          <i className="icon">&#xf065;</i>
...
const BottomModal = memo(function BottomModal(props) {
  ...
  const [checkedDepartStationsOptions, setCheckedDepartStationsOptions] =
    useReducer(
      checkedReducer,
      checkedDepartStations,
      (checkedDepartStations) => {
  ...
  const [checkedArriveStationsOptions, setCheckedArriveStationsOptions] =
    useReducer(
      checkedReducer,
      checkedArriveStations,
      (checkedArriveStations) => {
  ...
  const [checkedDepartTimeStart, setCheckedDepartTimeStart] =
    useState(departTimeStart);
  const [checkedDepartTimeEnd, setCheckedDepartTimeEnd] =
    useState(departTimeEnd);
  const [checkedArriveTimeStart, setCheckedArriveTimeStart] =
    useState(arriveTimeStart);
  const [checkedArriveTimeEnd, setCheckedArriveTimeEnd] =
    useState(arriveTimeEnd);
  ...
  const resetDisabled = useMemo(() => {
    return (
      Object.keys(checkedTrainTypeOptions).length === 0 &&
      ...
      checkedDepartTimeStart === 0 &&
      checkedDepartTimeEnd === 24 &&
      checkedArriveTimeStart === 0 &&
      checkedArriveTimeEnd === 24
    );
  }, [
    checkedTrainTypeOptions,
    checkedTicketsTypeOptions,
    checkedDepartStationsOptions,
    checkedArriveStationsOptions,
      ...
      <div className="bottom-dialog">
        <div className="bottom-dialog-content">
          <div className="title">
            ...
            <span onClick={() => onConfirmFilter()}>确认</span>
          </div>
