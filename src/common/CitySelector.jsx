...
const CityItem = memo(function CityItem(props) {
  ...
  return (
    <li className="city-li" onClick={() => onSelected(name)}>{name}</li>
  )
})
CityItem.propTypes = {
...
const CitySelector = memo(function CitySelector(props) {
  ...
  const {show, cityData, isLoading, onBack, onSelected,fetchCityData} = props
  ...
  return (
    <div className={classNames('city-selector',{hidden: !show})}>
      ...
      {
        Boolean(key) && <Suggest searchKey={searchKey} onSelected={onSelected} />
      }
      {OutputCitySelector()}
    </div>
  )
